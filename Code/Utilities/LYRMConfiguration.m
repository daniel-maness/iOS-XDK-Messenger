...
- (instancetype)initWithFileURL:(NSURL *)fileURL
{
    ...
    // Extract the name.
    NSString *name = configuration[LYRMConfigurationNameKey];
    ...
    // Extract the appID.
    NSString *appIDString = configuration[LYRMConfigurationAppIDKey];
    if (!appIDString) {
    ...
    NSString *identityProviderURLString = configuration[LYRMConfigurationIdentityProviderURLKey];
