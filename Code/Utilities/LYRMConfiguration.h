...
/**
 ...
 @endcode
 */
@interface LYRMConfiguration : NSObject
...
/**
 @abstract Initializes an `LYRMConfiguration` instance and loads the values
 ...
 @return Returns an intialized instance of `LYRMConfiguration`.
 */
