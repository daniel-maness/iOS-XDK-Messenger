...
extern NSString *const LYRMHTTPResponseErrorDomain;

typedef NS_ENUM(NSUInteger, LYRMHTTPResponseError) {
    LYRMHTTPResponseErrorInvalidContentType,
    LYRMHTTPResponseErrorUnexpectedStatusCode,
    LYRMHTTPResponseErrorClientError,
    LYRMHTTPResponseErrorServerError
};

/**
 @abstract The `LYRMHTTPResponseSerializer` provides a simple interface for deserializing HTTP responses created in the `LYRMAPIManager`.
 */
@interface LYRMHTTPResponseSerializer : NSObject
