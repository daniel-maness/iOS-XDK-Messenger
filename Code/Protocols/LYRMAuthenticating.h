...
/**
 @abstract The `LYRMAuthenticating` protocol must be adopted by objects that model users in the XDK Messenger application.
 */
@protocol LYRMAuthenticating <NSObject>
